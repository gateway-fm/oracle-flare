...
export interface ChainParameters {
    ...
    /**
     * Governance settings contract address. It is deployed to the fixed address  "0x183fAfF6997C98A812A3B98748Fc80241D08f312.".
     */
    ...
    /**
     * Governance settings deployer private key. Overriden if provided in `.env` file as `GOVERNANCE_SETTINGS_DEPLOYER_PRIVATE_KEY`. Not needed for hardhat tests.
     */
    governanceSettingsDeployerPrivateKey: string;
