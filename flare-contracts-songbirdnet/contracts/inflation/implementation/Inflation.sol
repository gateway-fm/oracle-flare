 ...
 **/
contract Inflation is IInflationGenesis, GovernedAndFlareDaemonizedV2, IFlareDaemonize, AddressUpdatable {
    ...
    constructor (
        ...
        GovernedAndFlareDaemonizedV2(_governance, _flareDaemon)
