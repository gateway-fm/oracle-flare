 ...
 * @notice Maintains the list of cleanable tokens for which history cleanup can be collectively cleaned up
 */
contract CleanupBlockNumberManager is GovernedV2, AddressUpdatable {
