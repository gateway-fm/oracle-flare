import { GovernanceSettingsInstance, GovernedV2Instance } from "../../../../typechain-truffle";

import { constants, expectEvent, expectRevert } from '@openzeppelin/test-helpers';
import { testDeployGovernanceSettings } from "../../../utils/contract-test-helpers";
const getTestFile = require('../../../utils/constants').getTestFile;

const GovernedV2 = artifacts.require("GovernedV2");
...
contract(`GovernedV2.sol; ${getTestFile(__filename)}; GovernedV2 unit tests`, async accounts => {
    ...
    describe("initialise", async () => {
        it("Should only initialize with non-zero governance", async () => {
            // Assemble
            // Act
            const promise = GovernedV2.new(constants.ZERO_ADDRESS);
            // Assert
