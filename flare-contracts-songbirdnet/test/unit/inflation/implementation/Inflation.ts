  ...
  describe("init", async () => {
    ...
    it("Should copy data from old inflation and create a new time slot after a day", async () => {
      ...
      const annum0 = web3.eth.abi.encodeParameters(
        [ "uint256", "uint16", "uint256", "uint256", "tuple(tuple(address, uint256, uint256, uint256, uint256, uint256)[], uint256, uint256, uint256, uint256)"],
        [ 0, 0, 0, 0, [[[receiver1.address, 5, 2, 4, 4, 4], [receiver2.address, 6, 1, 5, 5, 5]], 0, 0, 0, 0] ]);
      ...
      const annum1 = web3.eth.abi.encodeParameters(
        [ "uint256", "uint16", "uint256", "uint256", "tuple(tuple(address, uint256, uint256, uint256, uint256, uint256)[], uint256, uint256, uint256, uint256)"],
        [ 0, 0, 0, 0, [[[receiver2.address, 9, 2, 6, 6, 6], [receiver3.address, 7, 3, 3, 2, 2]], 0, 0, 0, 0] ]);
